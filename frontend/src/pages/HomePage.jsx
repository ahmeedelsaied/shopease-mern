  ...
  return (
    <div className="page-shell">
      ...
      <div className="space-y-20 sm:space-y-24">
        <section id="hero" className="relative overflow-hidden rounded-[2.6rem] bg-primary text-on-primary shadow-xl">
          ...
          <div className="relative grid gap-12 p-7 sm:p-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-center lg:p-16">
            ...
            <div className="relative min-h-[360px] lg:min-h-[430px]">
              ...
              <div className="absolute bottom-0 left-0 h-64 w-[76%] overflow-hidden rounded-[2rem] border border-primary-fixed/20 bg-primary-container shadow-2xl -rotate-3 sm:h-72">
        ...
        <section id="featured" className="space-y-7">
        ...
        <section id="deals" className="overflow-hidden rounded-[2.2rem] bg-secondary-container/55 p-6 sm:p-10 lg:p-12">
